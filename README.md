...
**MentorHub** — это современная платформа для соединения опытных IT-специалистов (менторов) с людьми, стремящимися развивать свои навыки и построить карьеру в сфере информационных технологий. 

> Платформа предоставляет полный набор инструментов для обучения, менторства и карьерного развития.
...
### 🔐 Улучшенная система аутентификации (v1.1)
...
### ⚡ Производительность и документация (v1.2)

- ✅ **Страницы ошибок** — кастомные 404, 500, global error boundary
- ✅ **Code splitting** — Webpack оптимизация, ленивая загрузка компонентов
- ✅ **Утилиты** — debounce, throttle, memoize для оптимизации
- ✅ **Документация** — [CONTRIBUTING.md](CONTRIBUTING.md) с 700+ строками guidelines

### 🔔 Система утилит и инфраструктура (v1.3)

- ✅ **Уведомления** — NotificationCenter с localStorage, toast-сообщения
- ✅ **API клиент** — централизованный клиент + WebSocket с автореконнектом
- ✅ **Валидация** — 15+ функций валидации форм (email, телефон, пароль, карты)
- ✅ **Работа с датами** — 20+ функций форматирования и манипуляций с русской локализацией
- ✅ **Форматирование** — числа, валюта, строки, цвета, массивы
- ✅ **Константы** — 290 строк централизованных констант и конфигурации
- 📝 **Документация** — [UTILITIES.md](UTILITIES.md) с полным описанием всех утилит
