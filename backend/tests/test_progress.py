...
def test_progress_lifecycle(client, sample_user_data):
    ...
    # create progress
    res = client.post("/api/v1/progress", json={"course_id": 200, "lesson_id": 1, "progress_percent": 25}, headers=headers)
    ...
    res2 = client.post("/api/v1/progress", json={"course_id": 200, "lesson_id": 1, "progress_percent": 60}, headers=headers)
