...
class TestGetMentors:
    ...
    def test_get_mentors_list(self, authenticated_client, sample_user_data):
...
class TestGetMentorById:
    ...
    def test_get_mentor_by_id(self, authenticated_client, sample_user_data):
    ...
    def test_get_mentor_invalid_id(self, authenticated_client, sample_user_data):
...
class TestBecomeMentor:
    ...
    def test_become_mentor_success(self, authenticated_client, sample_user_data, sample_mentor_data):
    ...
    def test_become_mentor_missing_fields(self, authenticated_client, sample_user_data):
    ...
    def test_become_mentor_experience_validation(self, authenticated_client, sample_user_data):
...
class TestUpdateMentorProfile:
    ...
    def test_update_mentor_profile(self, authenticated_client, sample_user_data):
...
class TestGetMentorReviews:
    ...
    def test_get_mentor_reviews(self, authenticated_client, sample_user_data):
...
class TestMentorAvailability:
    ...
    def test_get_mentor_availability(self, authenticated_client, sample_user_data):
    ...
    def test_set_mentor_availability(self, authenticated_client, sample_user_data):
...
class TestMentorStats:
    ...
    def test_get_mentor_stats(self, authenticated_client, sample_user_data):
...
class TestMentorValidation:
    ...
    def test_specialization_required(self, authenticated_client, sample_user_data):
