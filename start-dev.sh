...
PORT=8001 uvicorn app.main:app --reload --host 127.0.0.1 --port 8001 &
BACKEND_PID=$!
...
echo ""
echo -e "${CYAN}📍 URLs:${NC}"
echo -e "   Backend API:    ${CYAN}http://127.0.0.1:8001${NC}"
echo -e "   API Docs:       ${CYAN}http://127.0.0.1:8001/docs${NC}"
