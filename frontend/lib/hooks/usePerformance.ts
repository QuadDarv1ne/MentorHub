...
/**
 * Хук для IntersectionObserver (ленивая загрузка)
 */
...
/**
 * Хук для локального хранилища с поддержкой SSR
 */
...
/**
 * Хук для таймера с автоочисткой
 */
...
/**
 * Хук для интервала с автоочисткой
 */
