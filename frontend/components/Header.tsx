        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-gray-100">MentorHub</span>
            </Link>
          </div>

          {/* Компактная навигация (desktop) */}
          <div className="hidden md:flex items-center gap-6">
            <Link href="/mentors" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Менторы</Link>
            <Link href="/courses" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Курсы</Link>
            <Link href="/sessions" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Сессии</Link>
            <Link href="/messages" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Сообщения</Link>
            <NavMenu />
          </div>
